...
export interface JudgeTaskService<
  TaskProgress extends JudgeTaskProgress,
  ExtraInfo extends JudgeTaskExtraInfo,
> {
   ...
   */
  getTaskToBeSentToJudgeByTaskId(
    taskId: string,
    priority: number,
  ): Promise<JudgeTask<ExtraInfo>>;
}
